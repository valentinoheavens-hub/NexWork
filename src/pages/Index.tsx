    ...
    <div className="flex h-72">
      ...
      <div className="w-40 bg-white border-r border-slate-100 p-3 space-y-1 shrink-0">
        <div className="flex items-center gap-2 px-2 py-2 mb-3">
          ...
          <span className="text-xs font-bold text-slate-900">NexWork</span>
        </div>
        {["Overview","Clients","Projects","Invoices","Contracts"].map((item, i) => (
          <div key={item} className={cn(
            "flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs",
            i === 0 ? "bg-indigo-600 text-white font-bold" : "text-slate-500"
          )}>
      ...
      <div className="flex-1 bg-slate-50 p-4 space-y-3 overflow-hidden">
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            { label: "Active Projects", value: "8", color: "text-indigo-600" },
        ...
        <div className="bg-white rounded-xl border border-slate-100 overflow-hidden">
          ...
          {[
            { name: "Brand Identity", client: "Acme Corp", pct: 65, color: "bg-indigo-500" },
            ...
            <div key={p.name} className="flex items-center gap-3 px-3 py-2 border-b border-slate-50 last:border-0">
              <div className="w-6 h-6 rounded-lg bg-indigo-50 flex items-center justify-center text-[8px] font-black text-indigo-600">{p.name[0]}</div>
        ...
        <div className="flex items-center gap-2 bg-indigo-50 rounded-xl px-3 py-2">
          ...
          <p className="text-[9px] text-indigo-700 font-medium">Acme Corp signed the Brand Identity contract</p>
        </div>
      </div>
    </div>
  </div>
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Describe your scope in plain English. NexWork AI (powered by LLaMA 70B) generates a complete, professional contract in seconds.",
  },
  {
    icon: Shield,
...
const TESTIMONIALS = [
  {
    quote: "NexWork replaced 4 tools I was paying for. My client relationships have never been more professional.",
    name: "Amara Osei",
    ...
    <div className="min-h-screen bg-white selection:bg-indigo-100 overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/signin">
              <Button className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 shadow-lg shadow-indigo-100">
                Get Started Free
              </Button>
            </Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-slate-100 bg-white px-6 py-4 space-y-3">
            ...
            <Link to="/signin" className="block">
              <Button className="w-full bg-indigo-600 text-white mt-2">Get Started Free</Button>
            </Link>
          </div>
        )}
      </nav>
      ...
      <section className="pt-20 pb-28 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <a href="#features" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 text-indigo-700 text-sm font-bold mb-8 hover:bg-indigo-100 transition-colors">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight mb-6 leading-[1.05]">
            Run your agency.<br />
            <span className="text-indigo-600">Not your spreadsheets.</span>
          </h1>

          <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            NexWork replaces Notion, DocuSign, Stripe, and your project tracker with a single AI-powered workspace.
            Client portals, contracts, invoicing, and payments — built for agencies in Africa and beyond.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
            <Link to="/signin">
              <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 h-14 text-base rounded-2xl shadow-xl shadow-indigo-200 gap-2 group">
                Start for free
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="absolute inset-0 bg-indigo-600/10 blur-3xl rounded-full -z-10 scale-90" />
          <DashboardMockup />
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-indigo-400 font-bold uppercase tracking-widest text-sm mb-4">The freelancer tax</p>
          ...
          <div className="inline-flex items-center gap-3 bg-indigo-600 rounded-2xl px-8 py-4">
            <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
              <span className="text-white font-black text-lg">N</span>
            </div>
            <span className="text-white font-bold text-lg">NexWork replaces all of them</span>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-32 bg-slate-50 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <p className="text-indigo-600 font-bold uppercase tracking-widest text-sm mb-3">Features</p>
      ...
      <section id="how-it-works" className="py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20">
            <p className="text-indigo-600 font-bold uppercase tracking-widest text-sm mb-3">How it works</p>
      ...
      <section className="py-24 bg-slate-50 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-indigo-600 font-bold uppercase tracking-widest text-sm mb-3">Testimonials</p>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900">Agencies love NexWork</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t) => (
      ...
      <section id="pricing" className="py-32 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <p className="text-indigo-600 font-bold uppercase tracking-widest text-sm mb-3">Pricing</p>
                ...
                <ul className="space-y-3">
                  {plan.features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5">
                      <Check className={cn("w-4 h-4 shrink-0 mt-0.5", plan.highlight ? "text-indigo-200" : "text-indigo-600")} />
                      <span className={cn("text-sm", plan.highlight ? "text-indigo-100" : "text-slate-600")}>{f}</span>
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-4xl mx-auto bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          <div className="relative z-10">
            <p className="text-indigo-400 font-bold uppercase tracking-widest text-sm mb-4">Get started today</p>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
              Your agency deserves<br />better tools
            </h2>
            <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
              Join 500+ freelancers and agencies across Africa who run their entire business on NexWork. Free to start, no credit card required.
            </p>
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-12 mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm">
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-500">
                  <li><Link to="/signin" className="hover:text-indigo-600 transition-colors">Sign In</Link></li>
                  <li><Link to="/signin" className="hover:text-indigo-600 transition-colors">Create Account</Link></li>
