    ...
    <div className="min-h-screen bg-slate-50 py-12 px-6">
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4 shadow-lg shadow-indigo-100">N</div>
          <h1 className="text-3xl font-bold text-slate-900">Welcome to NexWork</h1>
        ...
        <Card className="border-none shadow-sm">
          <CardHeader className="bg-indigo-600 text-white rounded-t-xl">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-100">Project Intake</span>
            </div>
            <CardTitle>Brand Identity Redesign</CardTitle>
            <CardDescription className="text-indigo-100">Onboarding for Acme Corp</CardDescription>
          </CardHeader>
          <CardContent className="p-8 space-y-8">
            <div className="space-y-6">
              <div className="space-y-2">
                <Label className="text-slate-700 font-bold">What is your company's legal name?</Label>
                <Input placeholder="e.g. Acme Corp LLC" className="bg-slate-50 border-slate-200 focus:ring-indigo-500" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  className="min-h-[120px] bg-slate-50 border-slate-200 focus:ring-indigo-500" 
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  className="min-h-[80px] bg-slate-50 border-slate-200 focus:ring-indigo-500" 
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input type="date" className="bg-slate-50 border-slate-200 focus:ring-indigo-500" />
                </div>
                <div className="space-y-2">
                  <Label className="text-slate-700 font-bold">Estimated Budget Range</Label>
                  <select className="w-full rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <div className="pt-6 border-t border-slate-100">
              <Button 
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-6 text-lg rounded-xl group"
